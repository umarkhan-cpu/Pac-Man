...
2. Add special effects such as a power food, scared ghost & cherry.
3. Add a turn decision for the ghosts to allow them to make random decisions about which direction to go at each turn/intersection.
4. Add a pause button and game instructions.
